                ...
                <div className="flex gap-3">
                  {isLoading
                    ...
                    : cards.map((card) => (
                        ...
                        >
                          <div className="w-[110px] md:w-[140px] h-[110px] aspect-square rounded-2xl overflow-hidden relative border border-border shadow-sm bg-white dark:bg-black/20 card-press">
                            <img
                              src={card.image}
                              alt={card.Subtype || "festival template"}
                              className="w-full h-full object-cover"
